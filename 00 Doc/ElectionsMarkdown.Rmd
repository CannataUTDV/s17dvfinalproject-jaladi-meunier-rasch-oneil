...
![](../03\ Visualizations/Pics/Barchart.png)</center>
\n \n \n

Map of Bachelor Degree Attainment by Region and Victory Margin --
...
![](../03\ Visualizations/Pics/Map.png)</center>
![](../03\ Visualizations/Pics/Map2.png)</center>
\n \n \n

Percentage of Democratic Voters vs. Percentage Uninsured --
...
![](../03\ Visualizations/Pics/Scatterplot.png)</center>
\n \n \n
...
![](../03\ Visualizations/Pics/Dashboard.png)</center>
\n \n \n
...
![](../03\ Visualizations/Pics/Histogram.png)</center>
\n \n \n

Unemployment by Region and Victory Margin --

The following boxplots show the relationship between unemployment and victory margin, split up by region. It appears that there's no strong relationship between unemployment and victory margin, and it may not have been a key point of contention in voters' minds during this election.
![](../03\ Visualizations/Pics/Boxplot.png)</center>
\n \n \n

Median Incomes by Victory Margin and Region --
...
![](../03\ Visualizations/Pics/Crosstab.png)</center>
\n \n \n
